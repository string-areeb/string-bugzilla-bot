...
function getComments(bug, refresh) {
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (auth_1.shouldRefresh(error_1, refresh)) {
                        return [2 /*return*/, getComments(bug, true)];
                    }
                    throw error_1;
...
function addCommentTag(id, tag, refresh) {
    if (refresh === void 0) { refresh = false; }
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (auth_1.shouldRefresh(error_2, refresh)) {
                        return [2 /*return*/, addCommentTag(id, tag, true)];
                    }
                    throw error_2;
                case 5: return [2 /*return*/];
            }
...
function postComment(bug, tag, comment, refresh) {
    if (refresh === void 0) { refresh = false; }
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (auth_1.shouldRefresh(error_3, refresh)) {
                        return [2 /*return*/, postComment(bug, tag, comment, true)];
                    }
                    throw error_3;
                case 5: return [2 /*return*/];
            }
...
function addFixCommentForPr(pullRequest) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fixedIssues = links.getFixedIssueNumbers(pullRequest.body);
            promises = [];
