...
module.exports = {
    ...
    hasTagComment: function (comments) {
        return !!comments.find(function (comment) { return comment.tags.includes('gh-pr'); });
    },
    isBugAlreadyCommentedOn: function (bug) {
        return __awaiter(this, void 0, void 0, function () {
            var comments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        comments = _a.sent();
                        return [2 /*return*/, this.hasTagComment(comments)];
                }
            });
        });
    }
