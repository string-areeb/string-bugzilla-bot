...
var bugzilla_1 = __importDefault(require("./bugzilla"));
...
module.exports = function (app) {
    ...
    app.on(['issue_comment.created', 'issue_comment.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = links_1.default.replaceLinks(context.payload.comment.body);
    ...
    app.on(['issues.opened', 'issues.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = links_1.default.replaceLinks(context.payload.issue.body);
    ...
    app.on(['pull_request.opened', 'pull_request.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = links_1.default.replaceLinks(context.payload.pull_request.body);
                    return [4 /*yield*/, context.github.pullRequests.update(context.issue({
                            body: body
                        }))];
                case 1:
                    _a.sent();
    ...
    app.on(['pull_request.opened', 'pull_request.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bugzilla_1.default.addFixCommentForPr(context.payload.pull_request)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
